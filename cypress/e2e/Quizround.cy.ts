describe('One round of a quiz game, which works sometimes, depending on the correct answer not being clicked, due to disabled button if category not chosen', () => {
